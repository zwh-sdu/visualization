...
def drawt(root, depth):
    ...
    plt.text(tran(root.x),depth,root.tree,fontsize=30-3.5*depth, horizontalalignment="center",family="SimHei")
...
if __name__ == "__main__":
    ...
    drawtree = buchheim(trees[11])
    plt.figure(figsize=(16,16))
    drawt(drawtree,0)
    drawconn(drawtree,0)
    plt.savefig("欧冠欧联近三个赛季八强球队")
    plt.show()
